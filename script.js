...
es: {
  ...
  certifications: {
    ...
    sub: "Formación continua enfocada en IA, datos y automatización. Tocá una imagen para ver el certificado completo.",
    prev: "Anterior",
    next: "Siguiente",
    viewFull: "Ver certificado completo →",
    items: [
      { issuer:"DataCamp", title:"Introduction to Deep Learning with PyTorch", img:"certificados-img/deep-learning.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Introduction%20to%20Deep%20Learning%20with%20PyTorch.pdf" },
      { issuer:"DataCamp", title:"Image Processing in Python", img:"certificados-img/image-processing.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Image%20Processing%20in%20Python.pdf" },
      { issuer:"DataCamp", title:"Advanced Search and Innovative Research", img:"certificados-img/advanced-search.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Advanced%20Search%20and%20Innovative%20Research.pdf" },
      { issuer:"DataCamp", title:"Monetizing Artificial Intelligence", img:"certificados-img/monetizing-ai.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Monetizing%20Artificial%20Intelligence.pdf" },
      { issuer:"Certificación", title:"Introduction to Cybersecurity", img:"certificados-img/cybersecurity.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Introduction%20to%20Cybersecurity.pdf" },
      { issuer:"Yachay Tech", title:"Ayudante de Cátedra — Machine Learning", img:"certificados-img/ayudante-catedra.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/ayudante%20de%20c%C3%A1tedra.pdf" },
      { issuer:"Curso", title:"Get Started Quickly with Jira", img:"certificados-img/jira.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Get%20started%20quickly%20with%20Jira.pdf" },
      { issuer:"Curso", title:"Introduction to Python", img:"certificados-img/intro-python.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Introduction%20to%20Python.pdf" },
      { issuer:"Curso", title:"5G Basics: What it's all about", img:"certificados-img/5g-basics.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/5G%20Basics_%20What%20it's%20all%20about%20Jamil%20Andi.pdf" },
    ]
  },
  contact: {
...
en: {
  ...
  certifications: {
    ...
    sub: "Continuous learning focused on AI, data, and automation. Tap an image to view the full certificate.",
    prev: "Previous",
    next: "Next",
    ...
    items: [
      ...
      { issuer:"DataCamp", title:"Advanced Search and Innovative Research", img:"certificados-img/advanced-search.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Advanced%20Search%20and%20Innovative%20Research.pdf" },
      { issuer:"DataCamp", title:"Monetizing Artificial Intelligence", img:"certificados-img/monetizing-ai.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Monetizing%20Artificial%20Intelligence.pdf" },
      { issuer:"Certification", title:"Introduction to Cybersecurity", img:"certificados-img/cybersecurity.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Introduction%20to%20Cybersecurity.pdf" },
      { issuer:"Yachay Tech", title:"Teaching Assistant — Machine Learning", img:"certificados-img/ayudante-catedra.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/ayudante%20de%20c%C3%A1tedra.pdf" },
      { issuer:"Course", title:"Get Started Quickly with Jira", img:"certificados-img/jira.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Get%20started%20quickly%20with%20Jira.pdf" },
      { issuer:"Course", title:"Introduction to Python", img:"certificados-img/intro-python.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/Introduction%20to%20Python.pdf" },
      { issuer:"Course", title:"5G Basics: What it's all about", img:"certificados-img/5g-basics.jpg", pdf:"https://github.com/Andy-J12/Portfolio/blob/main/Certificates/5G%20Basics_%20What%20it's%20all%20about%20Jamil%20Andi.pdf" },
    ]
  },
  contact: {
...
function renderApp(lang){
  ...
  <section class="hero wrap" style="border-top:none;">
    <div class="hero-grid">
      ...
      <div class="hero-photo">
        <img src="foto-perfil.jpg" alt="Jamil Andi" width="700" height="933">
      </div>
    </div>
  ...
  const certItems = c.certifications.items;
  if(certIndex >= certItems.length) certIndex = 0;
  const cur = certItems[certIndex];
  ...
  <section id="certificaciones">
    <div class="wrap">
      ...
      <div class="cert-viewer">
        <button class="cert-nav prev" data-cert-nav="prev" aria-label="${c.certifications.prev}">&#8249;</button>
        <div class="cert-slide">
          <a class="cert-image-link" href="${cur.pdf}" target="_blank" rel="noopener" aria-label="${c.certifications.viewFull}">
            <img src="${cur.img}" alt="${cur.title}" loading="lazy">
          </a>
          <div class="cert-info">
            <div class="issuer">${cur.issuer}</div>
            <h4>${cur.title}</h4>
            <a class="link" href="${cur.pdf}" target="_blank" rel="noopener">${c.certifications.viewFull}</a>
          </div>
        </div>
        <button class="cert-nav next" data-cert-nav="next" aria-label="${c.certifications.next}">&#8250;</button>
      </div>
      <div class="cert-dots">
        ${certItems.map((_,i)=>`<button class="cert-dot ${i===certIndex?'is-active':''}" data-cert-dot="${i}" aria-label="${i+1}"></button>`).join('')}
      </div>
      <div class="cert-counter">${certIndex+1} / ${certItems.length}</div>
    </div>
  </section>`;
  ...
  <section id="contacto" class="contact">
    <div class="wrap">
      ...
      <div class="contact-ctas">
        ...
        <a class="btn btn-whatsapp" href="https://wa.me/593988081331" target="_blank" rel="noopener">${c.contact.ctaWhatsapp}</a>
      </div>
    </div>
  </section>`;
...
document.getElementById('app').addEventListener('click', (e)=>{
  const navBtn = e.target.closest('[data-cert-nav]');
  const dotBtn = e.target.closest('[data-cert-dot]');
  if(!navBtn && !dotBtn) return;
  const total = CONTENT[currentLang].certifications.items.length;
  if(navBtn){
    certIndex = navBtn.dataset.certNav === 'next'
      ? (certIndex + 1) % total
      : (certIndex - 1 + total) % total;
  } else {
    certIndex = parseInt(dotBtn.dataset.certDot, 10);
  }
